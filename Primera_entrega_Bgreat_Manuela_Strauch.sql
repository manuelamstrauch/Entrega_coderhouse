...
-- Se crean las tablas definidas en el DER
CREATE TABLE zona(
	id_zona INT NOT NULL AUTO_INCREMENT,
    nombre VARCHAR(100) NOT NULL,
    precio_envio INT DEFAULT '200',
    PRIMARY KEY (id_zona)
)	COMMENT "TABLA DEFINIDA PARA ZONAS DE ENVIO CON SUS RESPECTIVOS PRECIOS DE ENVIO";
...
)	COMMENT "TABLA DEFINIDA PARA REGISTRO DELAS TRANSACCIONES DEL NEGOCIO";
